...
public class CheckoutCartAdapter extends RecyclerView.Adapter<CheckoutCartAdapter.MyViewHolder> {
    ...
    public CheckoutCartAdapter(Context mContext, ArrayList<CartModelItems> cartList) {
    ...
    @Override
    public CheckoutCartAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.checkout_row_list, parent, false);

        return new CheckoutCartAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(CheckoutCartAdapter.MyViewHolder holder, int position) {
