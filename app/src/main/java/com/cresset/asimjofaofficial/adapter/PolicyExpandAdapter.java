...
import com.cresset.asimjofaofficial.customfonts.CustomFont;
...
public class PolicyExpandAdapter extends BaseExpandableListAdapter {
    ...
    public PolicyExpandAdapter(Context context, List<String> listDataHeader, HashMap<String, List<String>> listChildData) {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.policy_list_item, null);
        }
